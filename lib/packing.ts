...
export type PackOwner = "shared" | "youngha" | "joonho";
...
const OWNERS: PackOwner[] = ["shared", "youngha", "joonho"];
...
// 후쿠오카 5월(따뜻·습함·소나기 가능) 2인 여행 기준 기본 체크리스트.
const PRESET: Array<{ label: string; category: PackCategory }> = [
  ...
  { label: "JPY 환전 (소액 현금 ¥10,000~)", category: "money" },
  { label: "해외 결제용 카드 (트래블월렛/카드)", category: "money" },
  { label: "SUGOCA / Nimoca — 현지 역에서 구매", category: "money" },
  { label: "휴대폰 + 케이스", category: "tech" },
  { label: "보조배터리 (기내 휴대)", category: "tech" },
  { label: "충전기 + 케이블 (C타입/라이트닝)", category: "tech" },
  { label: "A타입 어댑터 (일본 100V)", category: "tech" },
  { label: "eSIM 설치 / 포켓 와이파이", category: "tech" },
  { label: "이어폰", category: "tech" },
  { label: "반팔·얇은 옷 (5월 후쿠오카 낮 22~26℃)", category: "clothes" },
  { label: "얇은 겉옷 / 가디건 (실내 냉방·밤 ~17℃)", category: "clothes" },
  ...
  { label: "접이식 우산 (5월말 장마 시작 가능)", category: "clothes" },
