...
alter table public.trip_memories add column if not exists photo_captions jsonb not null default '{}'::jsonb;
...
-- migrations for older deployments
alter table public.trip_days add column if not exists journal text not null default '';
